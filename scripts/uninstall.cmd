@echo off
:: ============================================
:: Dying Light Head Tracking - Uninstall
:: ============================================
...
set "LEGACY_DLLS=DyingLightHeadTracking.asi.bak"
...
set "PRESERVE_FILES=CameraUnlock.ini DyingLightHeadTracking.ini"
:: Config and log files the mod writes at runtime, removed from wherever the
:: DLLs were deployed.
set "MOD_LEFTOVERS=DyingLightHeadTracking.log DyingLightHeadTracking.prev.log DyingLightHeadTracking.shot"
